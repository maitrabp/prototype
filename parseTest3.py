#---------THIS FILE IS FOR MY BACK-END WORK (PLEASE IGNORE IF PUSHED TO MASTER) ---------------------------
import re
import pdfplumber
import pandas as pd
...
#-------------------------------------global vars --------------------------------------------------
mainDF = pd.DataFrame() #this is the main dataframe (kind of like a database where all data is stored)
#these are for storing the page numbers which have the following info
...
def nextPageContinued(nextPagetext):
    ...
    #------------------Filters----------------------------------------
    county_filter = re.compile(r'COUNTY')
...
file_parse('C:/Users/binde/Documents/Python/prototype/WashtenawCountyFY18_annotated nb edits.pdf')